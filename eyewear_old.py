'''This class is for providing a structure to a pair of Eyewear. The format of it should print: Material > Vision type > Clear/Sun > Included Options. For example: Polycarbonate, No-Line Multifocal, Clear, w/ AR, w/ BL'''
class Eyewear:
    def __init__(self,ewid,lens,material,options):
        self.ewid = ewid # The identification number of the eyewear. (Integer)
